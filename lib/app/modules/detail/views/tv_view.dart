        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: ListView.builder(
                shrinkWrap: true,
                itemCount: controller.tv.value.genres == null ? 0 : controller.tv.value.genres.length,
                ...
                itemBuilder: (context, int i) {
                  return Container(
                    ...
                    child: Chip(
                      ...
                      elevation: 1,
                      label: Text(
                        controller.tv.value.genres[i].name,
                        style: TextStyle(
                          color: Colors.white,
                        ),
                      ),
                  ...
                  Expanded(
                    ...
                    child: Align(
                      ...
                      child: CustomButton(
                        height: 40,
                        elevation: 1,
                        text: controller.tv.value.voteAverage.toString(),
          ...
          SliverToBoxAdapter(
            child: Container(
              margin: EdgeInsets.symmetric(horizontal: 20),
              child: Text(
                controller.tv.value.firstAirDate.year.toString(),
              ...
              child: TabBarView(
                children: <Widget>[
                  Container(
                    ...
                    height: 210,
                    child: ListView.builder(
                      itemCount: controller.similarTv.value.results.length,
                      scrollDirection: Axis.horizontal,
                      itemBuilder: (context, int i) {
                        return Container(
                          width: 100,
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  controller.similarTv.value.results[i].name,
                                  maxLines: 2,
                  ...
                  Container(
                    child: ListView.builder(
                      itemCount: controller.videosTv.value.results == null ? 0 : controller.videosTv.value.results.length,
                      scrollDirection: Axis.horizontal,
                      itemBuilder: (context, int i) {
                        return Container(
                          width: 320,
                          ...
                          child: Stack(
                            ...
                            children: [
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    ...
                                    image: CachedNetworkImageProvider(
                                      "https://img.youtube.com/vi/${controller.videosTv.value.results[i].key}/mqdefault.jpg",
                                    ),
                                  ),
                                ),
                              ),
                              MaterialButton(
                                ...
                                onPressed: () => controller.launchUrl(key: controller.videosTv.value.results[i].key),
                                child: Icon(
                                  Icons.play_arrow_rounded,
                                  color: Colors.white,
                                  size: 30,
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      controller.videosTv.value.results[i].name,
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.center,
                                      style: Theme.of(context).textTheme.headline4.copyWith(
